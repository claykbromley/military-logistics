      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-180px)]">
          ...
          <div className="relative z-10 p-6 lg:p-12">
            <div className="max-w-6xl mx-auto space-y-6">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-foreground mb-3">Emergency & Roadside Support</h2>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Base Roadside Assistance Contacts</h3>
                    <p className="text-sm text-primary">Who to call when you're on or near base</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("base-assistance") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">On-Base Resources:</h5>
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Off-Base Resources:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                    ...
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Store These Numbers:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">On-Base Auto Hobby Shops</h3>
                    <p className="text-sm text-primary">DIY repairs with professional equipment</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("auto-hobby-shops") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">What's Available:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="bg-green-50 p-4 rounded-lg border border-green-200 dark:bg-green-900/20 dark:border-green-700/40">
                        <h6 className="font-semibold text-green-800 dark:text-green-300 mb-1">Typical Costs</h6>
                        <p className="text-sm text-green-700 dark:text-green-400">$5-10/hour for bay rental</p>
                        <p className="text-sm text-green-700 dark:text-green-400">Oil changes: $20-30 (supplies only)</p>
                      </div>
                      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/40">
                        <h6 className="font-semibold text-blue-800 dark:text-blue-300 mb-1">Who Can Use</h6>
                        <p className="text-sm text-blue-700 dark:text-blue-400">Active duty, retirees, dependents, DoD civilians</p>
                      </div>
                    </div>
                  </div>
                )}
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Emergency Kit Checklist</h3>
                    <p className="text-sm text-primary">Essential items to keep in your vehicle</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("emergency-kit") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="grid gap-4 md:grid-cols-2 mb-4">
                      <div>
                        <h5 className="font-semibold text-foreground mb-3">Basic Essentials:</h5>
                      ...
                      <div>
                        <h5 className="font-semibold text-foreground mb-3">Survival Items:</h5>
                        <ul className="space-y-2">
                          <li className="flex items-start gap-3 text-primary">
                            <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                    ...
                    <div className="bg-amber-50 border border-amber-200 dark:bg-amber-900/20 dark:border-amber-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-amber-800 dark:text-amber-300 mb-2">PCS Addition:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">What to Do in a Breakdown During PCS</h3>
                    <p className="text-sm text-primary">Step-by-step guide for roadside emergencies</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("breakdown-pcs") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">Immediate Steps:</h5>
                    <ol className="space-y-2 mb-4 list-decimal list-inside">
                      <li className="text-primary"><strong>Get to safety</strong> - Pull off the road completely, turn on hazards</li>
                      <li className="text-primary"><strong>Assess the situation</strong> - Is it safe to check the car? Stay in vehicle if on highway</li>
                      <li className="text-primary"><strong>Set up warning devices</strong> - Reflective triangles 50-100 feet behind car</li>
                      <li className="text-primary"><strong>Call for help</strong> - Roadside assistance, then family/sponsor</li>
                      <li className="text-primary"><strong>Document everything</strong> - Photos, location, what happened</li>
                    </ol>
                    <h5 className="font-semibold text-foreground mb-3">Who to Call:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <Phone className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    ...
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Keep Receipts!</h5>
                      <p className="text-blue-700 dark:text-blue-400 text-sm">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Natural Disaster Vehicle Prep</h3>
                    <p className="text-sm text-primary">Hurricanes, typhoons, flooding, and severe weather</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("disaster-prep") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="grid gap-4 md:grid-cols-3 mb-4">
                      <div className="bg-card p-4 rounded-lg border">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h6 className="font-semibold text-foreground">Hurricane/Typhoon</h6>
                        </div>
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h6 className="font-semibold text-foreground">Flooding</h6>
                        </div>
                        <ul className="space-y-1 text-sm text-primary">
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h6 className="font-semibold text-foreground">Winter Weather</h6>
                        </div>
                        <ul className="space-y-1 text-sm text-primary">
                    ...
                    <div className="bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-red-800 dark:text-red-300 mb-2">OCONUS Considerations:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Forms & Document Templates</h3>
                    <p className="text-sm text-primary">Downloadable checklists, POA templates, and more</p>
                  </div>
                  <ChevronDown
        ...
        <a href="https://www.mcbbutler.marines.mil/Portals/189/POA%20Vehicle%20(non%20rotating)-FILLABLE.pdf" target="_blank" rel="noopener noreferrer">
          ...
          <Download className="h-4 w-4 ml-auto" />
              ...
              {/* Quick Links */}
              <div className="mt-8">
                <h3 className="text-xl font-bold text-foreground mb-4">Emergency Resources</h3>
                <div className="grid gap-4 md:grid-cols-2">
