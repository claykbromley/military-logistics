          ...
          <div className="relative z-10 p-6 lg:p-12">
            <div className="max-w-6xl mx-auto space-y-6">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-foreground mb-3">Driver's License Resources for Service Members</h2>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-primary">Servicemembers Civil Relief Act protections</p>
                  </div>
                  <ChevronDown
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-primary">Extensions and options when stationed away from home</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("renewal-deployed") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <p className="text-primary mb-4">Many states offer automatic extensions when you're:</p>
                    ...
                    <h4 className="font-semibold text-foreground mb-3">Common Benefits:</h4>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Out-of-State Driving While Stationed</h3>
                    <p className="text-sm text-primary">When you need to update vs. when you don't</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("out-of-state") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    ...
                    <h4 className="font-semibold text-foreground mb-3">You May Need to Update If:</h4>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                    ...
                    <h4 className="font-semibold text-foreground mb-3">You Do NOT Need to Update If:</h4>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Military Spouse Driver's License Rules</h3>
                    <p className="text-sm text-primary">MSRRA protections for military spouses</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("spouse-rules") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    ...
                    <h4 className="font-semibold text-foreground mb-3">When Spouses Should Update Their License:</h4>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
                        <ChevronRight className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Driver's License While OCONUS</h3>
                    <p className="text-sm text-primary">Germany, Japan, Korea, and international permits</p>
                  </div>
                  <ChevronDown
                  ...
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="bg-card p-4 rounded-lg border">
                        <h4 className="font-semibold text-foreground mb-2">Germany</h4>
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <h4 className="font-semibold text-foreground mb-2">Japan</h4>
                        <ul className="space-y-1 text-sm text-primary">
                          <li>Requires a SOFA Driver's License</li>
                        </ul>
                      </div>
                      <div className="bg-card p-4 rounded-lg border">
                        <h4 className="font-semibold text-foreground mb-2">Korea</h4>
                        <ul className="space-y-1 text-sm text-primary">
                          <li>Installation-specific driving permits</li>
                        </ul>
                      </div>
                      <div className="bg-card p-4 rounded-lg border">
                        <h4 className="font-semibold text-foreground mb-2">International Driving Permit (IDP)</h4>
                        <ul className="space-y-1 text-sm text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Lost, Stolen, or Damaged License</h3>
                    <p className="text-sm text-primary">What to do when stationed away from home</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("lost-stolen") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h4 className="font-semibold text-foreground mb-3">If your license is lost while OCONUS or CONUS:</h4>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <ChevronRight className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    ...
                    <h4 className="font-semibold text-foreground mb-3">If stolen:</h4>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
                        <AlertCircle className="h-5 w-5 text-amber-500 mt-0.5 flex-shrink-0" />
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">REAL ID Requirements for Military Members</h3>
                    <p className="text-sm text-primary">What you need to know about REAL ID compliance</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("real-id") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <p className="text-primary mb-4">REAL ID is required for domestic air travel and base access.</p>
                    <h4 className="font-semibold text-foreground mb-3">Military Notes:</h4>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
