          ...
          <div className="relative z-10 p-6 lg:p-12">
            <div className="max-w-6xl mx-auto space-y-6">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-foreground mb-3">Legal Protections for Military Members</h2>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Servicemembers Civil Relief Act (SCRA)</h3>
                    <p className="text-sm text-primary">Comprehensive legal protections for active-duty service members</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("scra-overview") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    ...
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Who Qualifies:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">SCRA 6% Interest Rate Cap</h3>
                    <p className="text-sm text-primary">Reduce interest on pre-service debts to 6% APR</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("scra-interest-cap") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="bg-green-50 border border-green-200 dark:bg-green-900/20 dark:border-green-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-green-800 dark:text-green-300 mb-2">Key Benefit: 6% Maximum Interest Rate</h5>
                    ...
                    <h5 className="font-semibold text-foreground mb-3">What's Covered:</h5>
                    ...
                    <h5 className="font-semibold text-foreground mb-3">How to Apply:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Vehicle Repossession Protection</h3>
                    <p className="text-sm text-primary">No repossession without a court order</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("scra-repossession") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-red-800 dark:text-red-300 mb-2">Critical Protection</h5>
                    ...
                    <h5 className="font-semibold text-foreground mb-3">What This Means:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Vehicle Lease Termination Rights</h3>
                    <p className="text-sm text-primary">Terminate auto leases early for PCS or deployment</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("lease-termination") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Qualifying Events:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                    ...
                    <h5 className="font-semibold text-foreground mb-3">How to Terminate:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <ChevronRight className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    ...
                    <div className="bg-green-50 border border-green-200 dark:bg-green-900/20 dark:border-green-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-green-800 dark:text-green-300 mb-2">No Early Termination Fees!</h5>
                      <p className="text-green-700 dark:text-green-400 text-sm">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Military Lending Act (MLA)</h3>
                    <p className="text-sm text-primary">36% APR cap and predatory lending protection</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("mla-protections") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    ...
                    <div className="bg-purple-50 border border-purple-200 dark:bg-purple-900/20 dark:border-purple-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-purple-800 dark:text-purple-300 mb-2">Key MLA Protections:</h5>
                      <ul className="space-y-2">
                        <li className="flex items-start gap-3 text-purple-700 dark:text-purple-400">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">What Loans Are Covered:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Protect Your Car from Theft & Vandalism</h3>
                    <p className="text-sm text-primary">Security measures during deployment</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("theft-vandalism-legal") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="bg-amber-50 border border-amber-200 dark:bg-amber-900/20 dark:border-amber-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-amber-800 dark:text-amber-300 mb-2">Warning</h5>
                      <p className="text-amber-700 dark:text-amber-400 text-sm">
                        Deployed service members are frequent targets for theft, especially near large bases. 
                        Take precautions before you leave.
                      </p>
                    </div>
                    <h5 className="font-semibold text-foreground mb-3">Security Tips:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Multistate & PCS Insurance Rules</h3>
                    <p className="text-sm text-primary">How changing duty locations affects your coverage</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("multistate-pcs") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">When You PCS:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <ChevronRight className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Accident Reporting:</h5>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">How to Apply for SCRA Benefits</h3>
                    <p className="text-sm text-primary">Step-by-step guide to invoke your protections</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("apply-benefits") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">Step 1: Gather Documentation</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Step 2: Send Written Requests</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <ChevronRight className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Step 3: Follow Up</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <ChevronRight className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                    ...
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Free Legal Help:</h5>
              ...
              {/* Quick Tools */}
        <div className="mt-8">
          <h3 className="text-xl font-bold text-foreground mb-4">Templates & Quick Resources</h3>
