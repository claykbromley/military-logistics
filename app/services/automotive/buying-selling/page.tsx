          ...
          <div className="relative z-10 p-6 lg:p-12">
            <div className="max-w-6xl mx-auto space-y-6">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-foreground mb-3">Buying & Selling a Car</h2>
              ...
              <div className="mb-8">
                ...
                <Card className="border border-border overflow-hidden mb-4 p-0">
                  <button
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-foreground mb-1">Car Buying Checklist</h4>
                      <p className="text-sm text-primary">Budgeting, financing, inspection, and negotiation</p>
                    </div>
                    <ChevronDown
                  ...
                  {expandedSections.includes("buying-checklist") && (
                    <div className="px-6 pb-6 pt-2 border-t bg-">
                      <div className="space-y-4">
                        <div>muted
                          <h5 className="font-semibold text-foreground mb-2">Before You Shop:</h5>
                        ...
                        <div>
                          <h5 className="font-semibold text-foreground mb-2">At the Dealership:</h5>
                          <ul className="space-y-2">
                            <li className="flex items-start gap-3 text-primary">
                              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                ...
                <Card className="border border-border overflow-hidden mb-4 p-0">
                  ...
                  >
                    <div className="p-3 bg-red-100 dark:bg-red-900/20 rounded-lg">
                      <BadgeAlert className="h-6 w-6 text-red-600 dark:text-red-400" />
                    </div>
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-foreground mb-1">Avoiding Predatory Military "Specials"</h4>
                      <p className="text-sm text-primary">Recognizing inflated APRs, hidden fees, and scams</p>
                    </div>
                    <ChevronDown
                  ...
                  {expandedSections.includes("predatory-practices") && (
                    <div className="px-6 pb-6 pt-2 border-t bg-background">
                      <div className="bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-700/40 rounded-lg p-4 mb-4">
                        <h5 className="font-semibold text-red-800 dark:text-red-300 mb-2">Warning Signs to Watch For:</h5>
                        <ul className="space-y-2">
                          <li className="flex items-start gap-3 text-red-700 dark:text-red-400">
                      ...
                      <h5 className="font-semibold text-foreground mb-2">Common Unnecessary Add-ons to Decline:</h5>
                      <ul className="space-y-2">
                        <li className="flex items-start gap-3 text-primary">
                ...
                <Card className="border border-border overflow-hidden mb-4 p-0">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-foreground mb-1">Military-Friendly Financing Options</h4>
                      <p className="text-sm text-primary">Compare Navy Federal, USAA, PenFed, and local credit unions</p>
                    </div>
                    <ChevronDown
                  ...
                  {expandedSections.includes("financing-options") && (
                    <div className="px-6 pb-6 pt-2 border-t bg-background">
                      <div className="grid gap-4 md:grid-cols-2 mb-4">
                        <a href="https://www.navyfederal.org/loans-cards/auto-loans.html" target="_blank" rel="noopener noreferrer" className="bg-card p-4 rounded-lg border hover:border-primary transition-colors">
                        ...
                        <a href="https://www.usaa.com/inet/wc/bank-auto-loan-main" target="_blank" rel="noopener noreferrer" className="bg-card p-4 rounded-lg border hover:border-primary transition-colors">
                          <h5 className="font-semibold text-foreground mb-2 flex items-center gap-2">
                            USAA
                            <ExternalLink className="h-4 w-4 text-primary" />
                          </h5>
                        ...
                        <a href="https://www.penfed.org/auto/new-auto-loans" target="_blank" rel="noopener noreferrer" className="bg-card p-4 rounded-lg border hover:border-primary transition-colors">
                          <h5 className="font-semibold text-foreground mb-2 flex items-center gap-2">
                            PenFed Credit Union
                            <ExternalLink className="h-4 w-4 text-primary" />
                          </h5>
                        ...
                        <div className="bg-card p-4 rounded-lg border">
                          <h5 className="font-semibold text-foreground mb-2">Local Credit Unions</h5>
                          <ul className="space-y-1 text-sm text-primary">
                ...
                <Card className="border border-border overflow-hidden mb-4 p-0">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-foreground mb-1">Military SCRA Car Loan Benefits</h4>
                      <p className="text-sm text-primary">Lower interest, waived fees, and repossession protections</p>
                    </div>
                    <ChevronDown
                ...
                <Card className="border border-border overflow-hidden mb-4 p-0">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-foreground mb-1">Used Car Inspection Guide</h4>
                      <p className="text-sm text-primary">What to check before buying - engine, tires, electronics, fluids, VIN</p>
                    </div>
                    <ChevronDown
                  ...
                  {expandedSections.includes("used-car-inspection") && (
                    <div className="px-6 pb-6 pt-2 border-t bg-background">
                      <div className="grid gap-4 md:grid-cols-2">
                        <div>
                          <h5 className="font-semibold text-foreground mb-2">Exterior & Tires</h5>
                          <ul className="space-y-1 text-sm text-primary">
                        ...
                        <div>
                          <h5 className="font-semibold text-foreground mb-2">Engine & Fluids</h5>
                          <ul className="space-y-1 text-sm text-primary">
                        ...
                        <div>
                          <h5 className="font-semibold text-foreground mb-2">Electronics</h5>
                          <ul className="space-y-1 text-sm text-primary">
                      ...
                      <div className="mt-4 bg-amber-50 border border-amber-200 dark:bg-amber-900/20 dark:border-amber-700/40 rounded-lg p-4">
                        <h5 className="font-semibold text-amber-800 dark:text-amber-300 mb-2">Always Get an Independent Inspection</h5>
              ...
              <div className="mb-8">
                ...
                <Card className="border border-border overflow-hidden mb-4 p-0">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-foreground mb-1">Determine Your Car's Market Value</h4>
                      <p className="text-sm text-primary">Research fair pricing before listing</p>
                    </div>
                    <ChevronDown
                  ...
                  {expandedSections.includes("market-value") && (
                    <div className="px-6 pb-6 pt-2 border-t bg-background">
                      <p className="text-primary mb-4">Use multiple sources to determine fair market value:</p>
                      <div className="grid gap-4 md:grid-cols-3 mb-4">
                        <a href="https://www.kbb.com/" target="_blank" rel="noopener noreferrer" className="bg-card p-4 rounded-lg border hover:border-primary transition-colors text-center">
                          <h5 className="font-semibold text-foreground flex items-center justify-center gap-2">
                            Kelley Blue Book
                            <ExternalLink className="h-4 w-4 text-primary" />
                          </h5>
                        </a>
                        <a href="https://www.edmunds.com/" target="_blank" rel="noopener noreferrer" className="bg-card p-4 rounded-lg border hover:border-primary transition-colors text-center">
                          <h5 className="font-semibold text-foreground flex items-center justify-center gap-2">
                            Edmunds
                            <ExternalLink className="h-4 w-4 text-primary" />
                          </h5>
                        </a>
                        <a href="https://www.nadaguides.com/" target="_blank" rel="noopener noreferrer" className="bg-card p-4 rounded-lg border hover:border-primary transition-colors text-center">
                          <h5 className="font-semibold text-foreground flex items-center justify-center gap-2">
                            NADA Guides
                            <ExternalLink className="h-4 w-4 text-primary" />
                          </h5>
                ...
                <Card className="border border-border overflow-hidden mb-4 p-0">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-foreground mb-1">How to Sell on Base (Lemon Lot)</h4>
                      <p className="text-sm text-primary">POV Resale Lot procedures and requirements</p>
                    </div>
                    <ChevronDown
                  ...
                  {expandedSections.includes("selling-on-base") && (
                    <div className="px-6 pb-6 pt-2 border-t bg-background">
                      <div className="space-y-4">
                        <div>
                          <h5 className="font-semibold text-foreground mb-2">On-Base Procedures:</h5>
                          <ul className="space-y-2">
                            <li className="flex items-start gap-3 text-primary">
                              <ChevronRight className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                        ...
                        <div>
                          <h5 className="font-semibold text-foreground mb-2">Required Documentation:</h5>
                          <ul className="space-y-2">
                            <li className="flex items-start gap-3 text-primary">
                ...
                <Card className="border border-border overflow-hidden mb-4 p-0">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-foreground mb-1">Selling While Stationed Overseas</h4>
                      <p className="text-sm text-primary">International considerations and customs procedures</p>
                    </div>
                    <ChevronDown
                ...
                <Card className="border border-border overflow-hidden mb-4 p-0">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-bold text-foreground mb-1">Alternative Selling Methods</h4>
                      <p className="text-sm text-primary">Online marketplaces and trade-in options</p>
                    </div>
                    <ChevronDown
                  ...
                  {expandedSections.includes("alternative-selling") && (
                    <div className="px-6 pb-6 pt-2 border-t bg-background">
                      <div className="grid gap-4 md:grid-cols-2 mb-4">
                        <div className="bg-card p-4 rounded-lg border">
                          <h5 className="font-semibold text-foreground mb-2">Online Marketplaces</h5>
                          <ul className="space-y-1 text-sm text-primary">
                            <li className="flex cursor-pointer">
                              <a href="/community/marketplace">Milify Marketplace</a>
                        ...
                        <div className="bg-card p-4 rounded-lg border">
                          <h5 className="font-semibold text-foreground mb-2">On-Base Options</h5>
                          <ul className="space-y-1 text-sm text-primary">
                      ...
                      <div>
                        <h5 className="font-semibold text-foreground mb-2">Trade-In Tips for Maximum Value:</h5>
                        <ul className="space-y-2">
                          <li className="flex items-start gap-3 text-primary">
                            <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              ...
              <div className="mt-8">
                <h3 className="text-xl font-bold text-foreground mb-4">Tools & Quick Resources</h3>
                <div className="grid gap-4 md:grid-cols-2">
                  <Button className="h-auto py-4 justify-start gap-3 bg-card cursor-pointer" variant="outline">
                  ...
                  <a 
                    ...
                    rel="noopener noreferrer"
                  >
                    <Button className="h-auto py-4 justify-start gap-3 bg-card w-full cursor-pointer" variant="outline">
