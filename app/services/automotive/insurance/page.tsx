          ...
          <div className="relative z-10 p-6 lg:p-12">
            <div className="max-w-6xl mx-auto space-y-6">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-foreground mb-3">Car Insurance for Military Members</h2>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Best Insurance Providers for Military</h3>
                    <p className="text-sm text-primary">USAA, GEICO Military, Navy Federal, and more</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("best-insurers") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="grid gap-4 md:grid-cols-2 mb-4">
                      <a href="https://www.usaa.com/inet/wc/auto-insurance" target="_blank" rel="noopener noreferrer" className="bg-card p-4 rounded-lg border hover:border-primary transition-colors">
                      ...
                      <a href="https://www.geico.com/information/military/" target="_blank" rel="noopener noreferrer" className="bg-card p-4 rounded-lg border hover:border-primary transition-colors">
                        <h5 className="font-semibold text-foreground mb-2 flex items-center gap-2">
                          GEICO Military
                          <ExternalLink className="h-4 w-4 text-primary" />
                        </h5>
                      ...
                      <a href="https://www.aafmaa.com/insurance/auto-insurance" target="_blank" rel="noopener noreferrer" className="bg-card p-4 rounded-lg border hover:border-primary transition-colors">
                        <h5 className="font-semibold text-foreground mb-2 flex items-center gap-2">
                          AAFMAA
                          <ExternalLink className="h-4 w-4 text-primary" />
                        </h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Save Money During Deployment</h3>
                    <p className="text-sm text-primary">Storage insurance and coverage adjustments</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("storage-deployment-insurance") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="bg-green-50 border border-green-200 dark:bg-green-900/20 dark:border-green-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-green-800 dark:text-green-300 mb-2">Potential Savings: 30-70% on Premiums</h5>
                      <p className="text-green-700 dark:text-green-400 text-sm">
                        Many service members save significantly during deployment by adjusting their coverage.
                      </p>
                    </div>
                    <h5 className="font-semibold text-foreground mb-3">What You Can Adjust:</h5>
                    ...
                    <div className="bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-red-800 dark:text-red-300 mb-2">Important Warnings:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Homeowner/Renters Insurance During Deployment</h3>
                    <p className="text-sm text-primary">Protecting your home while you're away</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("home-insurance") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="bg-amber-50 border border-amber-200 dark:bg-amber-900/20 dark:border-amber-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-amber-800 dark:text-amber-300 mb-2">Vacancy Warning (60-Day Rule)</h5>
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Steps to Take:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Life Insurance (SGLI)</h3>
                    <p className="text-sm text-primary">Servicemembers' Group Life Insurance and supplemental options</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("life-insurance") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">SGLI Coverage (Current as of 2026)</h5>
                    ...
                    <h5 className="font-semibold text-foreground mb-3">What You Should Do:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Other Financial Tips for Deployment</h3>
                    <p className="text-sm text-primary">SDP, SCRA benefits, and automatic payments</p>
                  </div>
                  <ChevronDown
                  ...
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="grid gap-4 md:grid-cols-2 mb-4">
                      <div className="bg-green-50 p-4 rounded-lg border border-green-200 dark:bg-green-900/20 dark:border-green-700/40">
                        <h5 className="font-semibold text-green-800 dark:text-green-300 mb-2">Savings Deposit Program (SDP)</h5>
                      ...
                      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/40">
                        <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">SCRA Benefits</h5>
                        <ul className="space-y-1 text-sm text-blue-700 dark:text-blue-400">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Before You Deploy:</h5>
