          ...
          <div className="relative z-10 p-6 lg:p-12">
            <div className="max-w-6xl mx-auto space-y-6">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-foreground mb-3">PCS & Vehicle Shipping</h2>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">What the Military Pays For</h3>
                    <p className="text-sm text-primary">Government coverage for POV shipping</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("military-pays") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">Government Typically Covers:</h5>
                    ...
                    <div className="bg-amber-50 border border-amber-200 dark:bg-amber-900/20 dark:border-amber-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-amber-800 dark:text-amber-300 mb-2">You Must Pay Out-of-Pocket For:</h5>
                      <ul className="space-y-2">
                        <li className="flex items-start gap-3 text-amber-700 dark:text-amber-400">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Financial Reimbursements</h3>
                    <p className="text-sm text-primary">MALT, Per Diem, and DLA rates</p>
                  </div>
                  <ChevronDown
                  ...
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="grid gap-4 md:grid-cols-3 mb-4">
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">MALT Rate</h5>
                        <p className="text-2xl font-bold text-primary mb-1">~$0.21/mile</p>
                        <p className="text-sm text-primary">Per-mile reimbursement for up to 2 POVs driven to new duty station</p>
                      </div>
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">Per Diem</h5>
                        <p className="text-2xl font-bold text-primary mb-1">Daily Rate</p>
                        <p className="text-sm text-primary">Allowance for lodging and meals for each authorized travel day</p>
                      </div>
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">DLA</h5>
                        <p className="text-2xl font-bold text-primary mb-1">One-Time</p>
                        <p className="text-sm text-primary">Dislocation Allowance for household relocation expenses</p>
                      </div>
                    </div>
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Authorized Travel Days Calculation:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Move Types & Restrictions</h3>
                    <p className="text-sm text-primary">CONUS, OCONUS, and PPM/DITY moves</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("move-types") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="space-y-4">
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">CONUS to CONUS</h5>
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">OCONUS (Overseas)</h5>
                        <p className="text-sm text-primary">
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">PPM/DITY Move</h5>
                        <p className="text-sm text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Vehicle Turn-In Procedures</h3>
                    <p className="text-sm text-primary">Appointments, documents, and inspection requirements</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("turn-in-procedures") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">Required Documents:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Inspection Requirements:</h5>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Weight Allowances & Shipping Rules</h3>
                    <p className="text-sm text-primary">Size restrictions and modification guidelines</p>
                  </div>
                  <ChevronDown
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Damage Claims & Timelines</h3>
                    <p className="text-sm text-primary">How to file claims if your vehicle is damaged during transport</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("damage-claims") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-red-800 dark:text-red-300 mb-2">Critical Timelines:</h5>
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Types of Claims:</h5>
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="bg-card p-4 rounded-lg border">
                        <h6 className="font-semibold text-foreground mb-1">Site Settlement</h6>
                        <p className="text-sm text-primary">On-the-spot repair/replacement with delivery agent</p>
                      </div>
                      <div className="bg-card p-4 rounded-lg border">
                        <h6 className="font-semibold text-foreground mb-1">IAL Claim</h6>
                        <p className="text-sm text-primary">Standard claim processed through International Auto Logistics</p>
                      </div>
                      <div className="bg-card p-4 rounded-lg border">
                        <h6 className="font-semibold text-foreground mb-1">Military Claim</h6>
                        <p className="text-sm text-primary">Filed with your branch's military claims office</p>
                      </div>
                      <div className="bg-card p-4 rounded-lg border">
                        <h6 className="font-semibold text-foreground mb-1">Inconvenience Claim</h6>
                        <p className="text-sm text-primary">For expenses like rental cars due to delayed delivery</p>
                      </div>
                    </div>
                    <a 
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Driving Your Car for PCS</h3>
                    <p className="text-sm text-primary">Safety tips, route planning, and GTCC usage</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("driving-pcs") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="space-y-4">
                      <div>
                        <h5 className="font-semibold text-foreground mb-2">Government Travel Charge Card (GTCC):</h5>
                        <ul className="space-y-2">
                          <li className="flex items-start gap-3 text-primary">
                            <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      ...
                      <div>
                        <h5 className="font-semibold text-foreground mb-2">Receipt Requirements:</h5>
                        <ul className="space-y-2">
                          <li className="flex items-start gap-3 text-primary">
                      ...
                      <div>
                        <h5 className="font-semibold text-foreground mb-2">PPM Weight Tickets:</h5>
                        <p className="text-sm text-primary">
                      ...
                      <div>
                        <h5 className="font-semibold text-foreground mb-2">Documentation to Carry:</h5>
                        <ul className="space-y-2">
                          <li className="flex items-start gap-3 text-primary">
                            <FileText className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                            <span>PCS orders</span>
