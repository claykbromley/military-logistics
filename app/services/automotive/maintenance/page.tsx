          ...
          <div className="relative z-10 p-6 lg:p-12">
            <div className="max-w-6xl mx-auto space-y-6">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-foreground mb-3">Vehicle Maintenance</h2>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Maintenance Schedule Guide</h3>
                    <p className="text-sm text-primary">When to service your vehicle based on mileage and time</p>
                  </div>
                  <ChevronDown
                  ...
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="grid gap-4 md:grid-cols-2 mb-4">
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">Every 3,000-5,000 Miles</h5>
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">Every 15,000-30,000 Miles</h5>
                        <ul className="space-y-1 text-sm text-primary">
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">Every 30,000-60,000 Miles</h5>
                        <ul className="space-y-1 text-sm text-primary">
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">Every 60,000-100,000 Miles</h5>
                        <ul className="space-y-1 text-sm text-primary">
                    ...
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/20 dark:border-blue-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Pro Tip for PCS:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Pre-PCS Vehicle Checklist</h3>
                    <p className="text-sm text-primary">Ensure your vehicle is ready for a long trip or shipment</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("pre-trip-checklist") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    ...
                    <h5 className="font-semibold text-foreground mb-2">Emergency Kit Essentials:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Government Benefits & Programs</h3>
                    <p className="text-sm text-primary">Programs to help with car ownership costs</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("govt-programs") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="space-y-4">
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">On-Base Auto Skills Centers</h5>
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">Military Discounts</h5>
                        <ul className="space-y-1 text-sm text-primary">
                      ...
                      <a href="https://www.militaryonesource.mil/" target="_blank" rel="noopener noreferrer" className="block bg-card p-4 rounded-lg border hover:border-primary transition-colors">
              ...
              {/* Quick Tools */}
              <div className="mt-8">
                <h3 className="text-xl font-bold text-foreground mb-4">Quick Tools & Resources</h3>
