          ...
          <div className="relative z-10 p-6 lg:p-12">
            <div className="max-w-6xl mx-auto space-y-6">
              <div className="text-center">
                <h2 className="text-3xl font-bold text-foreground mb-3">Deployment & Long-Term Storage</h2>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Battery Care & Maintenance</h3>
                    <p className="text-sm text-primary">Prevent drain and ensure reliable starts after storage</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("battery-care") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">Two Options for Battery Protection:</h5>
                    <div className="grid gap-4 md:grid-cols-2 mb-4">
                      <div className="bg-card p-4 rounded-lg border">
                        <h6 className="font-semibold text-foreground mb-2">Option 1: Disconnect</h6>
                    ...
                    <div className="bg-amber-50 border border-amber-200 dark:bg-amber-900/20 dark:border-amber-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-amber-800 dark:text-amber-300 mb-2">Important Warning:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Fluid Preparation</h3>
                    <p className="text-sm text-primary">Engine oil, fuel, coolant, and brake fluid maintenance</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("fluids-prep") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="space-y-4">
                      <div>
                        <h5 className="font-semibold text-foreground mb-2">Engine Oil</h5>
                      ...
                      <div>
                        <h5 className="font-semibold text-foreground mb-2">Fuel System</h5>
                        <ul className="space-y-2">
                          <li className="flex items-start gap-3 text-primary">
                      ...
                      <div>
                        <h5 className="font-semibold text-foreground mb-2">Other Fluids</h5>
                        <ul className="space-y-2">
                          <li className="flex items-start gap-3 text-primary">
                            <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Tire Protection</h3>
                    <p className="text-sm text-primary">Prevent flat spots and maintain tire integrity</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("tire-care") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">Basic Tire Prep:</h5>
                    ...
                    <h5 className="font-semibold text-foreground mb-3">For Long-Term Storage (6+ months):</h5>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Exterior Protection</h3>
                    <p className="text-sm text-primary">Paint protection, covers, and environmental considerations</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("exterior-protection") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">Before Storing:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Car Cover Selection:</h5>
                    <div className="grid gap-4 md:grid-cols-2 mb-4">
                      <div className="bg-green-50 p-4 rounded-lg border border-green-200 dark:bg-green-900/40 dark:border-green-700/40">
                        <h6 className="font-semibold text-green-800 dark:text-green-300 mb-2">DO Use:</h6>
                      ...
                      <div className="bg-red-50 p-4 rounded-lg border border-red-200 dark:bg-red-900/40 dark:border-red-700/40">
                        <h6 className="font-semibold text-red-800 dark:text-red-300 mb-2">DO NOT Use:</h6>
                    ...
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/40 dark:border-blue-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Ideal Storage Environment:</h5>
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Rodent & Pest Prevention</h3>
                    <p className="text-sm text-primary">Protect your vehicle from unwanted guests</p>
                  </div>
                  <ChevronDown
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Parking Brake Warning</h3>
                    <p className="text-sm text-primary">Critical information to avoid brake damage</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("parking-brake") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="bg-red-50 border border-red-200 dark:bg-red-900/40 dark:border-red-700/40 rounded-lg p-4 mb-4">
                      <h5 className="font-semibold text-red-800 dark:text-red-300 mb-2">DO NOT Engage Parking Brake for Storage</h5>
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Instead:</h5>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Where to Store Your Vehicle</h3>
                    <p className="text-sm text-primary">On-base, off-base, and climate-controlled options</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("storage-locations") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <div className="grid gap-4 md:grid-cols-3 mb-4">
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">On-Base Storage</h5>
                        <ul className="space-y-1 text-sm text-primary">
                      ...
                      <div className="bg-card p-4 rounded-lg border">
                        <h5 className="font-semibold text-foreground mb-2">Off-Base Storage</h5>
                        <ul className="space-y-1 text-sm text-primary">
                    ...
                    <div className="bg-blue-50 border border-blue-200 dark:bg-blue-900/40 dark:border-blue-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">Family/Friend Storage:</h5>
                      <p className="text-blue-700 dark:text-blue-400 text-sm">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Non-Operational Vehicle Registration</h3>
                    <p className="text-sm text-primary">Save money by registering as non-op during deployment</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("non-op-registration") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Benefits:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Process:</h5>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
                        <ChevronRight className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Theft & Vandalism Protection</h3>
                    <p className="text-sm text-primary">Security measures to protect your vehicle during deployment</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("theft-protection") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">Physical Security:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Electronic Security:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                    ...
                    <h5 className="font-semibold text-foreground mb-3">Documentation:</h5>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-3 text-primary">
              ...
              <Card className="border border-border overflow-hidden p-0">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-foreground mb-1">Insurance During Storage</h3>
                    <p className="text-sm text-primary">Adjust coverage and save money during deployment</p>
                  </div>
                  <ChevronDown
                ...
                {expandedSections.includes("storage-insurance") && (
                  <div className="px-6 pb-6 pt-2 border-t bg-background">
                    <h5 className="font-semibold text-foreground mb-3">Options to Consider:</h5>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-start gap-3 text-primary">
                        <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                    ...
                    <div className="bg-amber-50 border border-amber-200 dark:bg-amber-900/20 dark:border-amber-700/40 rounded-lg p-4">
                      <h5 className="font-semibold text-amber-800 dark:text-amber-300 mb-2">Important:</h5>
                      <p className="text-amber-700 dark:text-amber-400 text-sm">
              ...
              {/* Quick Tools */}
              <div className="mt-8">
                <h3 className="text-xl font-bold text-foreground mb-4">Quick Access Tools</h3>
